...
$arquivo_final2 = ["UTMX"=>"$utmx", "UTMY"=>"$utmy", "Altitude"=>"$altitude", "Temperatura"=>"$temperatura", "Pressão atmosférica"=>"$pressao", "Umidade"=>"$umidade", "Luminosidade"=>"$lux", "Velocidade do Vento"=>"$vvento"];
